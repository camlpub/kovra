...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'hace',
// Activity stream
    'CREATED_CONTACT' => 'creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
