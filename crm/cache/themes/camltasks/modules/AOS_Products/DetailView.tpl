...
{/if} 
<span class="sugar_field" id="{$fields.estampado_c.name}">{$fields.estampado_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.tono_c.name}">{$fields.tono_c.value}</span>
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.talla_c.name}">{$fields.talla_c.value}</span>
{/if}
